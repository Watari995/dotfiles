local required_parsers = { "go", "sql" }

return {
  "nvim-treesitter/nvim-treesitter",
  build = function()
    require("nvim-treesitter").install(required_parsers):wait(300000)
  ...
  config = function()
    ...
    local skip_ts = { make = true }

    -- Wrap vim.treesitter.start so picker previewers also respect skip_ts.
