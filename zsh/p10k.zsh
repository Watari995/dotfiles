# Generated by Powerlevel10k configuration wizard on 2026-01-17 at 04:39 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%4F'  # blue/purple foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # ブランチ名を省略しない（フル表示）
      res+="${meta}git:(${clean}${branch//\%/%%}${meta})"
    fi
    ...
    # Keep the prompt cheap and focused: show only branch/tag/commit.
